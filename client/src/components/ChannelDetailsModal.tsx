          ...
          <div className="flex-1 flex flex-col min-h-0 overflow-hidden">
            <div className="flex-1 overflow-y-auto px-4 py-3 space-y-2.5">
              <div>
                ...
                <p className="text-sm text-muted-foreground">x{mainGift?.quantity || 1}</p>
              </div>
              ...
              >
                <div className="flex-1 min-w-0 mr-2">
                  <p className="text-sm text-blue-500 group-hover:text-blue-600 font-medium truncate">
                    {channelName}
                  </p>
                </div>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between p-2.5 rounded-lg bg-gradient-to-r from-green-500/10 to-emerald-500/10 border border-green-500/20">
                  <span className="text-sm text-muted-foreground">{t.home.price}</span>
                ...
                <div className="flex items-center justify-between p-2.5 rounded-lg bg-gradient-to-r from-blue-500/10 to-cyan-500/10 border border-blue-500/20">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-sm text-muted-foreground">{t.home.cashback} 7.5%</span>
                  </div>
                  <div className="flex items-center gap-1.5">
                    <img src={tonLogo} alt="TON" className="w-4 h-4 rounded-full" />
            ...
            <div className="px-4 pb-3 pt-2">
              <Button
                onClick={handleBuy}
                className="w-full h-11 rounded-lg bg-gradient-to-r from-blue-600 to-cyan-500 hover:from-blue-700 hover:to-cyan-600 shadow-lg shadow-blue-500/20 text-white font-bold text-base transition-all duration-300 hover:shadow-xl hover:scale-[1.02] active:scale-[0.98]"
