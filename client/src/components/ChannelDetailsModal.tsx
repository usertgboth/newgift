...
export default function ChannelDetailsModal({
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="p-0 gap-0 max-w-[80vw] w-full sm:max-w-[320px] max-h-[65vh] border-0 overflow-hidden flex flex-col">
        <VisuallyHidden>
        ...
        <div className="flex flex-col sm:flex-row flex-1 min-h-0 overflow-hidden">
          <div className="relative w-full sm:w-2/5 h-32 sm:h-auto bg-gradient-to-br from-primary/10 to-primary/5 flex-shrink-0">
            <img
              src={image}
              alt={giftName}
          ...
          <div className="flex-1 flex flex-col min-h-0 overflow-hidden">
            <div className="flex-1 overflow-y-auto px-3 py-2.5 space-y-2">
              ...
              <div className="space-y-1.5">
                <div className="flex items-center justify-between p-1.5 rounded-lg bg-gradient-to-r from-green-500/10 to-emerald-500/10 border border-green-500/20">
                  <span className="text-xs text-muted-foreground">{t.home.price}</span>
                  <div className="flex items-center gap-1">
                    <img src={tonLogo} alt="TON" className="w-3 h-3 rounded-full" />
                    <span className="text-sm font-bold text-foreground" data-testid="text-modal-price">
                      {price}
                    </span>
                ...
                <div className="flex items-center justify-between p-1.5 rounded-lg bg-gradient-to-r from-blue-500/10 to-cyan-500/10 border border-blue-500/20">
                  <div className="flex items-center gap-1">
                  ...
                  <div className="flex items-center gap-1">
                    <img src={tonLogo} alt="TON" className="w-3 h-3 rounded-full" />
                    <span className="text-xs font-bold text-blue-500">+{cashback}</span>
